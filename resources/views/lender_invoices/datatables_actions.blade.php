{!! Form::open(['route' => ['lenderInvoices.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group'>

<?php $invoice= \App\Models\LenderInvoice::where('id',$id)->first();
if($invoice){
?>
...
<?php } ?>
    ...
    <!-- <a href="{{ route('lenderInvoices.edit', $id) }}" class='btn btn-default btn-xs'>
