...
<body>
        ...
        <nav
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right text-left" data-app-modern-menu="true">
                    ...
                    <li class="nav-item dropdown text-left"><a class="nav-link link dropdown-toggle text-primary display-4"
                        href="#" data-toggle="dropdown-submenu" aria-expanded="false">Apply</a>
                    <div class="dropdown-menu text-left">
                        <a class="dropdown-item text-primary display-4 text-left"
                            href="#">Loans</a>
                    ...
                    <li class="nav-item dropdown text-left"><a class="nav-link link dropdown-toggle text-primary display-4"
                        href="#" data-toggle="dropdown-submenu" aria-expanded="false">Become</a>
                    <div class="dropdown-menu text-left">
                        <a class="dropdown-item text-primary display-4 text-left"
                            href="#">Lender</a>
    ...
    <section class="header8 cid-rYMyQ3IifK mbr-parallax-background" id="header8-1q">
                    ...
                    <div class="modalWindow-video-container">
                        <div class="modalWindow-video">
                            <iframe width="100%" height="100%" frameborder="0" allowfullscreen="1"
                                data-src="https://www.youtube.com/watch?v=5uzZiqM5gIc&amp;list=RDMM5uzZiqM5gIc&amp;start_radio=1"></iframe>
                        </div>
    ...
    <section class="mbr-section form3 cid-rYMRYFsTOi" id="form3-21"
            ...
            <div class="row py-2 justify-content-center">
                <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoid">
                    ...
                    <form action="#" method="POST" class="mbr-form form-with-styler"
                        data-form-title="All Trust Consult Form"><input type="hidden" name="email" data-form-email="true"
                            value="MdooWMwLlt2/71MTIkVh0/1Z3L4iRrnxGR7/rsXU4t9NaOcpJ+RG2+LVRXnQVdNadieg6RZte6xx2r9Gk15KGOt4sAcYV6obs1FThKdV4JGB30ZYR+Ut6ZyKvp+4KvZA">
                        <div class="row">
                        ...
                        <div class="dragArea row">
                            <div class="form-group col" data-for="email">
                                <input type="email" name="email" placeholder="Search" data-form-field="Email"
                                    required="required" class="form-control display-7" id="email-form3-21">
                            </div>
    ...
    <section once="footers" class="cid-rYMLarFBTs mbr-reveal" id="footer7-1x">
