...
<!-- Image Field -->
<div class="form-group col-sm-6">
@if (isset($conferenceSession) && $conferenceSession->image)
        <figure class="figure" style="width:50%">
                    <img src="/thumbnail/{{$conferenceSession->image}}" style="width:100%" class="figure-img img-fluid rounded" alt="{{$conferenceSession->title}}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('conferenceSessions.index') }}" class="btn btn-default">Cancel</a>
</div>
