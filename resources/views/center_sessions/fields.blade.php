...
<!-- Image Field -->
<div class="form-group col-sm-6">
@if ($centerSession && $centerSession->image)
        <figure class="figure" style="width:50%">
                    <img src="/thumbnail/{{$centerSession->image}}" style="width:100%" class="figure-img img-fluid rounded" alt="{{$centerSession->title}}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('centerSessions.index') }}" class="btn btn-default">Cancel</a>
</div>
