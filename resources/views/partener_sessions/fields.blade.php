...
<!-- Image Field -->
<div class="form-group col-sm-6">
@if (isset($partenerSession) && $partenerSession->image)
        <figure class="figure" style="width:50%">
                    <img src="/thumbnail/{{$partenerSession->image}}" style="width:100%" class="figure-img img-fluid rounded" alt="{{$partenerSession->title}}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('partenerSessions.index') }}" class="btn btn-default">Cancel</a>
</div>
