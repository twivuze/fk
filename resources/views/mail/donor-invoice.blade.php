...
.col-6 {
 ...
 <?php 
 $invoice = \App\Models\DonationInvoice::find($id);
 $recipient= \App\Models\LoanApplication::find($invoice->enterprise_id);
 $receipt= \App\Models\Donor::find($invoice->donor_id);
 ?>
			...
			<div class="col-md-12">
				<div class="invoice-wrapper" id="invoice-wrapper">
					...
					<div class="payment-info">
						<div class="row">
							<div class="col-6">
                            <img src='{{env("APP_URL", "https://alltrust.theeventx.com")}}/assets/images/a-122x30.png' alt="All Trust Consult" title="" style="width:120px;height:auto">
							...
							<div class="col-6 text-right">
								...
								<strong>{{$invoice->receipt_id}}</strong>
							</div>
						</div>
					</div>
					...
					<div class="payment-details">
						<div class="row">
							...
							<div class="col-6 text-right">
								<span>Recipient </span>
								<strong>
									{{$recipient->business_name?$recipient->business_name:$recipient->name}}
								</strong><br>
								<strong >
                                ...
                                <table style="margin-top:40px;width:100%;border-bottom:1px #000 solid;border-top:1px #000 solid">
                                 <tr> <th>Total paid</th> <th>${{$invoice->amount}}</th> </tr>  </table>
							</div>
						</div>
					</div>
                ...
                Donation
						...
						<div class="total text-right">
							...
							<div class="field">
								Subtotal <span>${{$invoice->amount}}</span>
							</div>
							<!-- <div class="field">
