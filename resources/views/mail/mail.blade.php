                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        style="display: block;height: auto;width: 100%;border: 0;max-width: 122px;"
                                        src="{{env('APP_URL', 'http://alltrust.theeventx.com')}}/images/mailLogo/a-1-122x30.png"
                                        alt="" width="122" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                        <div
                                            ...
                                            <h1
                                                style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 22px;line-height: 31px;font-family: Avenir,sans-serif;text-align: center;">
                                                {{$title}}</h1>{!!html_entity_decode($contents)!!}
                                        </div>
                                    </div>
