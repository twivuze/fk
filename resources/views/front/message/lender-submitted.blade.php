...
['title'=>'Become Lender Form Submission',
'description'=>'Become Lender Form Submission'
]
)
    ...
    <div class="container mt-3">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>Become Lender Form Submission.</strong>
                </h2>
                ...
                <div class="row">
                    ...
                    <div class="alert alert-success alert-dismissible fade show mt-5 ml-5 text-center title"
                        ...
                        <p>
                            ...
                            And we assure you, business you selected for capital funding/loan will be carried on as soon
                            as possible.
                        </p>
