...
<?php $manager= \App\Models\Lender::where('status','Active')->where('id',$id)->orderBy('id','DESC')->first();
            ...
            <div class="col-sm-8">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php $enterprises= \App\Models\LenderInvoice::where('payment_status','successful')
                    ->where('lender_id',$id)->orderBy('id','DESC')->paginate(5);;
                        ...
                        <section class="features17 cid-rYUhzEzUWQ" id="features17-2w">
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <th>TOTAL</th>
                                        <th>USD <?php echo \App\Models\LenderInvoice::where('payment_status','successful')
                    ->where('lender_id',$id)->orderBy('id','DESC')->sum('amount');?></th>
                                        <th></th>
