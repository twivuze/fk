...
['title'=>'Become Lender',
'description'=>'Become Lender Form'
]
)
    ...
    <div class="container mt-3">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>Become Lender Form</strong></h2>
...
<?php $session= \App\Models\LenderSession::where('allow_to_apply',1)->orderBy('id','DESC')->first();
if($session){
?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6">
                <div class="row media-container-column">
                    ...
                    {!! Form::open(['route' => 'lenders.store','files' => true]) !!}

                    @include('lenders.fields',['session_id'=>$session->id])
