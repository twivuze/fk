...
['title'=>'Become Partener',
'description'=>'Become Partener Form'
]
)
    ...
    <div class="container mt-3">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>Become Partener Form</strong></h2>
...
<?php $session= \App\Models\PartenerSession::where('allow_to_apply',1)->orderBy('id','DESC')->first();
if($session){
?>
            ...
            <div class="col-sm-6">
                <div class="row media-container-column">
                    <style>
                        ...
                        @include('partners.fields',['session_id'=>$session->id])
