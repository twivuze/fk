...
['title'=>'Become Micro-finance Center',
'description'=>'Become Micro-finance Center Form'
]
)
    ...
    <div class="container mt-3">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><strong>Become Micro-finance Center Form</strong></h2>
...
<?php $session= \App\Models\CenterSession::where('allow_to_apply',1)->orderBy('id','DESC')->first();
if($session){
?>
