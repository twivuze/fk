...
@section('content')
    ...
    <?php if(\Request::get('session')){
        ...
        if( $session ){
            ...
            echo'<h1 class="pull-left">Conference Applications</h1>'; 
        }
        ...
        <h1 class="pull-right">
        <?php if(\Request::get('session')){?>
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="/conferenceSessions">Back</a>
       <?php }
        ?>
        </h1>
    </section>
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('conference_applications.table')
            </div>
        </div>
