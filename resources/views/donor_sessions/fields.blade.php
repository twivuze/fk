...
<!-- Image Field -->
<div class="form-group col-sm-6">
@if ($donorSession && $donorSession->image)
        <figure class="figure" style="width:50%">
                    <img src="/thumbnail/{{$donorSession->image}}" style="width:100%" class="figure-img img-fluid rounded" alt="{{$donorSession->title}}">
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('donorSessions.index') }}" class="btn btn-default">Cancel</a>
</div>
