<li class="{{ Request::is('microFundApplications*') ? 'active' : '' }}">
    <a href="{{ route('microFundApplications.index') }}"><i class="fa fa-edit"></i><span>MicroFund Applications</span></a>
</li>
...
<li class="{{ Request::is('userAccounts*') ? 'active' : '' }}">
    <a href="{{ route('userAccounts.index') }}"><i class="fa fa-edit"></i><span>User Accounts</span></a>
</li>
