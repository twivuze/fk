{!! Form::open(['route' => ['internalFunders.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group'>
    <!-- <a href="{{ route('internalFunders.show', $id) }}" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>
    <a href="{{ route('internalFunders.edit', $id) }}" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-edit"></i> -->
    <!-- </a> -->
    <?php $invoice= \App\Models\InternalFunder::where('id',$id)->first();
if($invoice){
?>
...
<?php } ?>
    ...
    <div id="receipt-content-{{$id}}" style="display: none"> 
            <div class="container">
            @include('receipt.internal-fund',['id',$id])
            </div>
    </div>
