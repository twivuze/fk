...
use Auth;
class LenderInvoiceDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'lender_invoices.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\LenderInvoice $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(LenderInvoice $model)
    {
       ...
       }else if(Auth::check() && Auth::user()->type=='Lender'){ 
        $lender= \App\Models\Lender::where('user_id',Auth::id())->orderBy('id','DESC')->first();
        return $model->where('lender_id',$lender->id)->orderBy('id','DESC');
       }
