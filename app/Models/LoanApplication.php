...
class LoanApplication extends Model
{
    ...
    public static $rules = [
        ...
        'formal_reference_name' => 'required',
        'formal_reference_phone' => 'required',
        'formal_reference_email' => 'required',
        'alternative_contact_name' => 'required',
        'alternative_contact_email' => 'required',
        'alternative_contact_phone' => 'required',
        'alternative_contact_id_number' => 'required',
        'upload_passport_photo' =>  "image|mimes:jpeg,png,jpg",
